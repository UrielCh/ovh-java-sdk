...
public class ApiOvhDbaastimeseries extends ApiOvhBase {
	...
	private static TypeReference<ArrayList<OvhRegion>> t1 = new TypeReference<ArrayList<OvhRegion>>() {};
	...
	private static TypeReference<ArrayList<OvhOpenTSDBToken>> t3 = new TypeReference<ArrayList<OvhOpenTSDBToken>>() {};
	...
	private static TypeReference<ArrayList<OvhKey>> t6 = new TypeReference<ArrayList<OvhKey>>() {};
	...
	private static TypeReference<ArrayList<OvhConsumption>> t7 = new TypeReference<ArrayList<OvhConsumption>>() {};
}
