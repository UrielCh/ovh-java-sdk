...
public class ApiOvhVps extends ApiOvhBase {
	...
	private static TypeReference<ArrayList<Date>> t2 = new TypeReference<ArrayList<Date>>() {};
	...
	private static TypeReference<ArrayList<OvhAttached>> t3 = new TypeReference<ArrayList<OvhAttached>>() {};
	...
	private static TypeReference<OvhUnitAndValue<Double>> t5 = new TypeReference<OvhUnitAndValue<Double>>() {};
	...
	private static TypeReference<ArrayList<OvhModel>> t6 = new TypeReference<ArrayList<OvhModel>>() {};
	...
	private static TypeReference<ArrayList<OvhVpsOptionEnum>> t7 = new TypeReference<ArrayList<OvhVpsOptionEnum>>() {};
	...
	private static TypeReference<ArrayList<OvhGeolocationEnum>> t9 = new TypeReference<ArrayList<OvhGeolocationEnum>>() {};
