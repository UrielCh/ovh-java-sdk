...
public class ApiOvhOrder extends ApiOvhBase {
	 ...
	 * @param serviceName [required] The project id
	 */
	public OvhOrder cloud_project_serviceName_ip_POST(String serviceName, Long quantity, String instanceId, OvhGeolocationEnum country) throws IOException {
		String qPath = "/order/cloud/project/{serviceName}/ip";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "quantity", quantity);
	 ...
	 * @param serviceName [required] Your line number
	 */
	public OvhOrder telephony_lines_serviceName_hardware_POST(String serviceName, String shippingContactId, Boolean retractation, String hardware, String mondialRelayId) throws IOException {
		String qPath = "/order/telephony/lines/{serviceName}/hardware";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param serviceName [required] Your trunk number
	 */
	public OvhOrder telephony_trunks_serviceName_hardware_POST(String serviceName, String shippingContactId, Boolean retractation, String hardware, String mondialRelayId) throws IOException {
		String qPath = "/order/telephony/trunks/{serviceName}/hardware";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "shippingContactId", shippingContactId);
	 ...
	 * @param brand [required] Spare phone brand model
	 */
	public OvhOrder telephony_spare_new_POST(String mondialRelayId, Long quantity, Long shippingContactId, String brand) throws IOException {
		String qPath = "/order/telephony/spare/new";
		StringBuilder sb = path(qPath);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "mondialRelayId", mondialRelayId);
	 ...
	 * @param billingAccount [required] The name of your billingAccount
	 */
	public OvhOrder telephony_billingAccount_line_POST(String billingAccount, Boolean retractation, String brand, OvhLineTypeEnum[] types, Long[] ownerContactIds, String mondialRelayId, Long quantity, Long shippingContactId, Long[] extraSimultaneousLines, String[] zones, String[] offers, Boolean[] displayUniversalDirectories) throws IOException {
		String qPath = "/order/telephony/{billingAccount}/line";
		StringBuilder sb = path(qPath, billingAccount);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "retractation", retractation);
	 ...
	 * @param billingAccount [required] The name of your billingAccount
	 */
	public OvhOrder telephony_billingAccount_numberNogeographic_POST(String billingAccount, String socialNomination, String organisation, String city, String streetNumber, OvhNumberPoolEnum pool, String name, String ape, OvhNumberCountryEnum country, String email, Boolean displayUniversalDirectory, String firstname, OvhNumberOffer offer, Boolean retractation, String specificNumber, String streetName, String phone, OvhLegalFormEnum legalform, String siret, String zip) throws IOException {
		String qPath = "/order/telephony/{billingAccount}/numberNogeographic";
		StringBuilder sb = path(qPath, billingAccount);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param billingAccount [required] The name of your billingAccount
	 */
	public OvhOrder telephony_billingAccount_numberGeographic_POST(String billingAccount, String ape, String name, OvhNumberCountryEnum country, String zone, String socialNomination, String organisation, OvhNumberPoolEnum pool, String city, String streetNumber, String email, Boolean displayUniversalDirectory, String firstname, Boolean retractation, OvhNumberOffer offer, OvhLegalFormEnum legalform, String siret, String zip, String phone, String streetName, String specificNumber) throws IOException {
		String qPath = "/order/telephony/{billingAccount}/numberGeographic";
		StringBuilder sb = path(qPath, billingAccount);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "ape", ape);
	 ...
	 * @param billingAccount [required] The name of your billingAccount
	 */
	public OvhOrder telephony_billingAccount_numberSpecial_POST(String billingAccount, String name, String ape, OvhNumberCountryEnum country, String socialNomination, String organisation, OvhNumberPoolEnum pool, String city, String streetNumber, String email, Boolean displayUniversalDirectory, String firstname, Boolean retractation, String range, OvhLegalFormEnum legalform, String siret, String zip, String specificNumber, String phone, String streetName, OvhNumberSpecialTypologyEnum typology) throws IOException {
		String qPath = "/order/telephony/{billingAccount}/numberSpecial";
		StringBuilder sb = path(qPath, billingAccount);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "name", name);
	 ...
	 * @param billingAccount [required] The name of your billingAccount
	 */
	public OvhOrder telephony_billingAccount_portability_POST(String billingAccount, OvhSocialReason socialReason, OvhOfferType offer, String rio, Double floor, String firstName, Boolean fiabilisation, Boolean executeAsSoonAsPossible, String streetNumberExtra, String streetName, String mobilePhone, String siret, String zip, String contactName, String callNumber, OvhNumberType type, String city, Double streetNumber, String lineToRedirectAliasTo, String name, String building, OvhCountriesAvailable country, String contactNumber, OvhSpecialNumberCategoryEnum specialNumberCategory, Boolean displayUniversalDirectory, Double stair, String streetType, Date desireDate, String door, String listNumbers) throws IOException {
		String qPath = "/order/telephony/{billingAccount}/portability";
		StringBuilder sb = path(qPath, billingAccount);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param billingAccount [required] The name of your billingAccount
	 */
	public OvhOrder telephony_billingAccount_accessories_POST(String billingAccount, String mondialRelayId, String[] accessories, Long shippingContactId, Boolean retractation) throws IOException {
		String qPath = "/order/telephony/{billingAccount}/accessories";
		StringBuilder sb = path(qPath, billingAccount);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "mondialRelayId", mondialRelayId);
	...
	private static TypeReference<ArrayList<OvhWebHostingProductInformation>> t4 = new TypeReference<ArrayList<OvhWebHostingProductInformation>>() {};
	...
	private static TypeReference<ArrayList<OvhConfigurationRequirements>> t6 = new TypeReference<ArrayList<OvhConfigurationRequirements>>() {};
	...
	private static TypeReference<ArrayList<OvhProductInformation>> t7 = new TypeReference<ArrayList<OvhProductInformation>>() {};
	 ...
	 * @param duration [required] Duration
	 */
	public OvhOrder license_plesk_new_duration_POST(String duration, OvhOrderablePleskLanguagePackEnum languagePackNumber, String ip, Boolean wordpressToolkit, OvhLicenseTypeEnum serviceType, Boolean resellerManagement, Boolean powerpack, OvhPleskApplicationSetEnum applicationSet, OvhOrderablePleskDomainNumberEnum domainNumber, OvhPleskVersionEnum version, OvhOrderableAntivirusEnum antivirus) throws IOException {
		String qPath = "/order/license/plesk/new/{duration}";
		StringBuilder sb = path(qPath, duration);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param duration [required] Duration
	 */
	public OvhOrder license_plesk_serviceName_upgrade_duration_POST(String serviceName, String duration, OvhOrderablePleskLanguagePackEnum languagePackNumber, Boolean wordpressToolkit, OvhPleskApplicationSetEnum applicationSet, OvhOrderablePleskDomainNumberEnum domainNumber, OvhOrderableAntispamEnum antispam, Boolean resellerManagement, Boolean powerpack, OvhPleskVersionEnum version, OvhOrderableAntivirusEnum antivirus) throws IOException {
		String qPath = "/order/license/plesk/{serviceName}/upgrade/{duration}";
		StringBuilder sb = path(qPath, serviceName, duration);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "languagePackNumber", languagePackNumber);
	 ...
	 * @param duration [required] Duration
	 */
	public OvhOrder license_worklight_new_duration_POST(String duration, Boolean lessThan1000Users, String ip, OvhWorkLightVersionEnum version) throws IOException {
		String qPath = "/order/license/worklight/new/{duration}";
		StringBuilder sb = path(qPath, duration);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param duration [required] Duration
	 */
	public OvhOrder license_windows_new_duration_POST(String duration, String ip, OvhWindowsSqlVersionEnum sqlVersion, OvhLicenseTypeEnum serviceType, OvhWindowsOsVersionEnum version) throws IOException {
		String qPath = "/order/license/windows/new/{duration}";
		StringBuilder sb = path(qPath, duration);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "ip", ip);
	 ...
	 * @param duration [required] Duration
	 */
	public OvhOrder license_cpanel_new_duration_POST(String duration, String ip, OvhOrderableCpanelVersionEnum version, OvhLicenseTypeEnum serviceType) throws IOException {
		String qPath = "/order/license/cpanel/new/{duration}";
		StringBuilder sb = path(qPath, duration);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "ip", ip);
	 ...
	 * @param duration [required] Duration
	 */
	public OvhOrder license_virtuozzo_new_duration_POST(String duration, OvhLicenseTypeEnum serviceType, OvhOrderableVirtuozzoVersionEnum version, OvhOrderableVirtuozzoContainerNumberEnum containerNumber, String ip) throws IOException {
		String qPath = "/order/license/virtuozzo/new/{duration}";
		StringBuilder sb = path(qPath, duration);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "serviceType", serviceType);
	 ...
	 * @param duration [required] Duration
	 */
	public OvhOrder license_office_new_duration_POST(String duration, Long officeBusinessQuantity, String giftCode, Long officeProPlusQuantity) throws IOException {
		String qPath = "/order/license/office/new/{duration}";
		StringBuilder sb = path(qPath, duration);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * API beta
	 */
	public OvhOrder overTheBox_serviceName_migrate_POST(String serviceName, Long shippingRelayID, OvhShippingMethodEnum shippingMethod, String offer, String shippingContactID, Boolean hardware) throws IOException {
		String qPath = "/order/overTheBox/{serviceName}/migrate";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param duration [required] Duration
	 */
	public OvhOrder dedicated_server_serviceName_ip_duration_POST(String serviceName, String duration, OvhIpCountryEnum country, String organisationId, OvhIpTypeOrderableEnum type, OvhIpBlockSizeEnum blockSize) throws IOException {
		String qPath = "/order/dedicated/server/{serviceName}/ip/{duration}";
		StringBuilder sb = path(qPath, serviceName, duration);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "country", country);
	 ...
	 * @param duration [required] Duration
	 */
	public OvhOrder hosting_privateDatabase_new_duration_POST(String duration, OvhAvailableRamSizeEnum ram, OvhOrderableVersionEnum version, OvhDatacenterEnum datacenter, OvhOfferEnum offer) throws IOException {
		String qPath = "/order/hosting/privateDatabase/new/{duration}";
		StringBuilder sb = path(qPath, duration);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "ram", ram);
	 ...
	 * @param duration [required] Duration
	 */
	public OvhOrder hosting_web_new_duration_POST(String duration, Boolean waiveRetractationPeriod, OvhDnsZoneEnum dnsZone, net.minidev.ovh.api.hosting.web.OvhOfferEnum offer, OvhOrderableNameEnum module, String domain) throws IOException {
		String qPath = "/order/hosting/web/new/{duration}";
		StringBuilder sb = path(qPath, duration);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "waiveRetractationPeriod", waiveRetractationPeriod);
	 ...
	 * @param duration [required] Duration
	 */
	public OvhOrder hosting_web_serviceName_changeMainDomain_duration_POST(String serviceName, String duration, OvhMxPlanEnum mxplan, String domain) throws IOException {
		String qPath = "/order/hosting/web/{serviceName}/changeMainDomain/{duration}";
		StringBuilder sb = path(qPath, serviceName, duration);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param duration [required] Duration
	 */
	public OvhOrder saas_csp2_new_duration_POST(String duration, Long officeProPlusQuantity, String giftCode, Long officeBusinessQuantity) throws IOException {
		String qPath = "/order/saas/csp2/new/{duration}";
		StringBuilder sb = path(qPath, duration);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "officeProPlusQuantity", officeProPlusQuantity);
	 ...
	 * @param mondialRelayId [required] Use /supply/mondialRelay entry point to specify a relay point and ignore shipping contact address information entry.
	 */
	public OvhOrder xdsl_spare_new_POST(Long shippingContactId, String brand, Long quantity, String mondialRelayId) throws IOException {
		String qPath = "/order/xdsl/spare/new";
		StringBuilder sb = path(qPath);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "shippingContactId", shippingContactId);
	 ...
	 * @param duration [required] Duration
	 */
	public OvhOrder dedicatedCloud_serviceName_ip_duration_POST(String serviceName, String duration, String networkName, String description, Long estimatedClientsNumber, String usage, OvhOrderableIpBlockRangeEnum size, OvhIpCountriesEnum country) throws IOException {
		String qPath = "/order/dedicatedCloud/{serviceName}/ip/{duration}";
		StringBuilder sb = path(qPath, serviceName, duration);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param duration [required] Duration
	 */
	public OvhOrder dedicatedCloud_serviceName_host_duration_POST(String serviceName, String duration, Long quantity, Long datacenterId, String name) throws IOException {
		String qPath = "/order/dedicatedCloud/{serviceName}/host/{duration}";
		StringBuilder sb = path(qPath, serviceName, duration);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "quantity", quantity);
	 ...
	 * @param duration [required] Duration
	 */
	public OvhOrder email_exchange_organizationName_service_exchangeService_account_duration_POST(String organizationName, String exchangeService, String duration, OvhAccountQuotaEnum storageQuota, Long number, OvhOvhLicenceEnum licence) throws IOException {
		String qPath = "/order/email/exchange/{organizationName}/service/{exchangeService}/account/{duration}";
		StringBuilder sb = path(qPath, organizationName, exchangeService, duration);
		HashMap<String, Object>o = new HashMap<String, Object>();
