...
public class ApiOvhSms extends ApiOvhBase {
	 ...
	 * @param priority [required] The priority of the message
	 ...
	 * @param _class [required] The sms class
	 * @param receiversSlotId [required] The receivers document slot id
	 * @param message [required] The sms message
	 * @param coding [required] The sms coding
	 * @param validityPeriod [required] The maximum time -in minute(s)- before the message is dropped
	 * @param differedPeriod [required] The time -in minute(s)- to wait before sending the message
	 * @param charset [required] The sms coding
	 * @param serviceName [required] The internal name of your SMS offer
	 * @param number [required] The virtual number
	 */
	...
	private static TypeReference<ArrayList<OvhSenderAvailable>> t5 = new TypeReference<ArrayList<OvhSenderAvailable>>() {};
