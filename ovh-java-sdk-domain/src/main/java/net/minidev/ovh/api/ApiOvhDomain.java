...
public class ApiOvhDomain extends ApiOvhBase {
	...
	private static TypeReference<ArrayList<OvhOptin>> t5 = new TypeReference<ArrayList<OvhOptin>>() {};
	...
	private static TypeReference<ArrayList<net.minidev.ovh.api.domain.configurations.OvhOptin>> t8 = new TypeReference<ArrayList<net.minidev.ovh.api.domain.configurations.OvhOptin>>() {};
	...
	private static TypeReference<ArrayList<OvhObfuscatedEmails>> t9 = new TypeReference<ArrayList<OvhObfuscatedEmails>>() {};
