...
public class ApiOvhDomain extends ApiOvhBase {
	 ...
	 * @param zoneName [required] The internal name of your zone
	 */
	public OvhDynHostRecord zone_zoneName_dynHost_record_POST(String zoneName, String subDomain, String ip) throws IOException {
		String qPath = "/domain/zone/{zoneName}/dynHost/record";
		StringBuilder sb = path(qPath, zoneName);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param zoneName [required] The internal name of your zone
	 */
	public OvhRedirection zone_zoneName_redirection_POST(String zoneName, String keywords, String target, OvhRedirectionTypeEnum type, String subDomain, String description, String title) throws IOException {
		String qPath = "/domain/zone/{zoneName}/redirection";
		StringBuilder sb = path(qPath, zoneName);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param zoneName [required] The internal name of your zone
	 */
	public OvhRecord zone_zoneName_record_POST(String zoneName, Long ttl, String subDomain, OvhNamedResolutionFieldTypeEnum fieldType, String target) throws IOException {
		String qPath = "/domain/zone/{zoneName}/record";
		StringBuilder sb = path(qPath, zoneName);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "ttl", ttl);
	...
	private static TypeReference<ArrayList<OvhUkRegistrar>> t4 = new TypeReference<ArrayList<OvhUkRegistrar>>() {};
	...
	private static TypeReference<ArrayList<OvhWhoisObfuscatorFieldsEnum>> t5 = new TypeReference<ArrayList<OvhWhoisObfuscatorFieldsEnum>>() {};
	 ...
	 * @param serviceName [required] The internal name of your domain
	 */
	public net.minidev.ovh.api.domain.OvhTask serviceName_glueRecord_POST(String serviceName, String[] ips, String host) throws IOException {
		String qPath = "/domain/{serviceName}/glueRecord";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "ips", ips);
	...
	private static TypeReference<ArrayList<OvhOptin>> t6 = new TypeReference<ArrayList<OvhOptin>>() {};
	...
	private static TypeReference<ArrayList<OvhContactAllTypesEnum>> t7 = new TypeReference<ArrayList<OvhContactAllTypesEnum>>() {};
	...
	private static TypeReference<ArrayList<OvhObfuscatedEmails>> t8 = new TypeReference<ArrayList<OvhObfuscatedEmails>>() {};
	...
	private static TypeReference<ArrayList<net.minidev.ovh.api.domain.configurations.OvhOptin>> t9 = new TypeReference<ArrayList<net.minidev.ovh.api.domain.configurations.OvhOptin>>() {};
