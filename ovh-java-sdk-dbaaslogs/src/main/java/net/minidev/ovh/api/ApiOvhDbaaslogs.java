...
public class ApiOvhDbaaslogs extends ApiOvhBase {
	...
	private static TypeReference<ArrayList<OvhStreamRule>> t3 = new TypeReference<ArrayList<OvhStreamRule>>() {};
	...
	private static TypeReference<ArrayList<OvhPermission>> t4 = new TypeReference<ArrayList<OvhPermission>>() {};
	...
	private static TypeReference<ArrayList<OvhInputAction>> t5 = new TypeReference<ArrayList<OvhInputAction>>() {};
