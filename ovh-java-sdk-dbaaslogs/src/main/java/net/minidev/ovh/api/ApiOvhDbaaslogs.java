...
public class ApiOvhDbaaslogs extends ApiOvhBase {
	...
	private static TypeReference<ArrayList<OvhPermission>> t5 = new TypeReference<ArrayList<OvhPermission>>() {};
	...
	private static TypeReference<ArrayList<OvhStreamRule>> t6 = new TypeReference<ArrayList<OvhStreamRule>>() {};
