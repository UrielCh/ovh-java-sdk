...
import net.minidev.ovh.api.hosting.web.database.OvhRequestActionEnum;
...
public class ApiOvhHostingweb extends ApiOvhBase {
	 ...
	 * @param ttl [required] Expiration of your token (in seconds)
	...
	private static TypeReference<ArrayList<net.minidev.ovh.api.hosting.web.runtime.OvhTypeEnum>> t3 = new TypeReference<ArrayList<net.minidev.ovh.api.hosting.web.runtime.OvhTypeEnum>>() {};
	...
	private static TypeReference<ArrayList<OvhCreationDatabaseCapabilities>> t5 = new TypeReference<ArrayList<OvhCreationDatabaseCapabilities>>() {};
	 ...
	 */
	public OvhTask serviceName_database_name_request_POST(String serviceName, String name, OvhRequestActionEnum action) throws IOException {
	 ...
	 * @param serviceName [required] The internal name of your hosting
	 */
	public OvhTask serviceName_request_POST(String serviceName, net.minidev.ovh.api.hosting.web.OvhRequestActionEnum action) throws IOException {
	...
	private static TypeReference<ArrayList<OvhDatabaseTypeEnum>> t7 = new TypeReference<ArrayList<OvhDatabaseTypeEnum>>() {};
	...
	private static TypeReference<ArrayList<OvhVolumeHistory>> t9 = new TypeReference<ArrayList<OvhVolumeHistory>>() {};
	...
	private static TypeReference<ArrayList<OvhLanguageEnum>> t10 = new TypeReference<ArrayList<OvhLanguageEnum>>() {};
	...
	private static TypeReference<ArrayList<OvhVisibilityCheckResultResponse>> t11 = new TypeReference<ArrayList<OvhVisibilityCheckResultResponse>>() {};
	...
	private static TypeReference<ArrayList<OvhOfferEnum>> t12 = new TypeReference<ArrayList<OvhOfferEnum>>() {};
}
