...
import net.minidev.ovh.api.hosting.web.database.OvhStatisticsTypeEnum;
...
public class ApiOvhHostingweb extends ApiOvhBase {
	...
	private static TypeReference<ArrayList<OvhLanguageEnum>> t5 = new TypeReference<ArrayList<OvhLanguageEnum>>() {};
	...
	private static TypeReference<ArrayList<OvhTypeEnum>> t6 = new TypeReference<ArrayList<OvhTypeEnum>>() {};
	 ...
	 * @param serviceName [required] The internal name of your hosting
	 */
	public OvhTask serviceName_runtime_POST(String serviceName, OvhTypeEnum type, String name, String[] attachedDomains, String appEnv, String appBootstrap, String publicDir, Boolean isDefault) throws IOException {
		String qPath = "/hosting/web/{serviceName}/runtime";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "type", type);
	 ...
	 * @param serviceName [required] The internal name of your hosting
	 */
	public OvhTask serviceName_module_POST(String serviceName, Long moduleId, net.minidev.ovh.api.hosting.web.module.OvhLanguageEnum language, String path, String adminPassword, String adminName, String domain, OvhDependencyType[] dependencies) throws IOException {
		String qPath = "/hosting/web/{serviceName}/module";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param name [required] Database name (like mydb.mysql.db or mydb.postgres.db)
	 */
	public ArrayList<OvhChartSerie<OvhChartTimestampValue>> serviceName_database_name_statistics_GET(String serviceName, String name, OvhStatisticsPeriodEnum period, OvhStatisticsTypeEnum type) throws IOException {
	...
	private static TypeReference<ArrayList<OvhChartSerie<OvhChartTimestampValue>>> t8 = new TypeReference<ArrayList<OvhChartSerie<OvhChartTimestampValue>>>() {};
	 ...
	 * @param name [required] Database name (like mydb.mysql.db or mydb.postgres.db)
	 */
	public OvhTask serviceName_database_name_restore_POST(String serviceName, String name, Boolean sendEmail, OvhDateEnum date) throws IOException {
	 ...
	 * @param name [required] Database name (like mydb.mysql.db or mydb.postgres.db)
	 */
	public OvhTask serviceName_database_name_import_POST(String serviceName, String name, Boolean sendEmail, Boolean flushDatabase, String documentId) throws IOException {
	 ...
	 * @param name [required] Database name (like mydb.mysql.db or mydb.postgres.db)
	 */
	public OvhTask serviceName_database_name_dump_POST(String serviceName, String name, Boolean sendEmail, OvhDateEnum date) throws IOException {
		String qPath = "/hosting/web/{serviceName}/database/{name}/dump";
		StringBuilder sb = path(qPath, serviceName, name);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "sendEmail", sendEmail);
	 ...
	 * @param serviceName [required] The internal name of your hosting
	 */
	public OvhTask serviceName_database_POST(String serviceName, OvhDatabaseTypeEnum type, OvhExtraSqlQuotaEnum quota, OvhDatabaseCapabilitiesTypeEnum capabilitie, String password, String user, OvhVersionEnum version) throws IOException {
		String qPath = "/hosting/web/{serviceName}/database";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "type", type);
	 ...
	 */
	public OvhTask serviceName_ovhConfig_id_changeConfiguration_POST(String serviceName, Long id, OvhAvailableEngineVersionEnum engineVersion, OvhEngineNameEnum engineName, OvhContainerEnum container, OvhEnvironmentEnum environment, OvhHttpFirewallEnum httpFirewall) throws IOException {
	 ...
	 * @param serviceName [required] The internal name of your hosting
	 */
	public OvhTask serviceName_envVar_POST(String serviceName, String key, String value, net.minidev.ovh.api.hosting.web.envvar.OvhTypeEnum type) throws IOException {
		String qPath = "/hosting/web/{serviceName}/envVar";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "key", key);
	 ...
	 * @param serviceName [required] The internal name of your hosting
	 */
	public ArrayList<OvhChartSerie<OvhChartTimestampValue>> serviceName_statistics_GET(String serviceName, OvhStatisticsPeriodEnum period, net.minidev.ovh.api.hosting.web.OvhStatisticsTypeEnum type) throws IOException {
	 ...
	 * @param serviceName [required] The internal name of your hosting
	 */
	public String serviceName_cron_POST(String serviceName, String frequency, String email, net.minidev.ovh.api.hosting.web.cron.OvhStatusEnum status, String command, OvhLanguageEnum language, String description) throws IOException {
		String qPath = "/hosting/web/{serviceName}/cron";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param id [required] Id of the object
	 */
	public String serviceName_ownLogs_id_userLogs_POST(String serviceName, Long id, String password, Long ownLogsId, String login, String description) throws IOException {
		String qPath = "/hosting/web/{serviceName}/ownLogs/{id}/userLogs";
		StringBuilder sb = path(qPath, serviceName, id);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "password", password);
	 ...
	 * @param serviceName [required] The internal name of your hosting
	 */
	public OvhTask serviceName_attachedDomain_POST(String serviceName, Long runtimeId, String domain, OvhCdnEnum cdn, String ownLog, Boolean ssl, String path, OvhFirewallEnum firewall) throws IOException {
		String qPath = "/hosting/web/{serviceName}/attachedDomain";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
	...
	private static TypeReference<ArrayList<OvhCreationDatabaseCapabilities>> t9 = new TypeReference<ArrayList<OvhCreationDatabaseCapabilities>>() {};
	 ...
	 * @param serviceName [required] The internal name of your hosting
	 */
	public String serviceName_userLogs_POST(String serviceName, String password, Long ownLogsId, String login, String description) throws IOException {
		String qPath = "/hosting/web/{serviceName}/userLogs";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "password", password);
	 ...
	 */
	public OvhVisibilityCheckResponse localSeo_visibilityCheck_POST(String name, String street, String zip, OvhCountryEnum country) throws IOException {
