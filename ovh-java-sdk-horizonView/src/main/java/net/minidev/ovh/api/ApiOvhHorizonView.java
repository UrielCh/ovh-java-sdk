...
public class ApiOvhHorizonView extends ApiOvhBase {
	 ...
	 * @param domainTrustId [required] Domain trust id
	 */
	public OvhTask serviceName_domainTrust_domainTrustId_addDomainController_POST(String serviceName, Long domainTrustId, String domainControllerIp, String domain) throws IOException {
