...
import net.minidev.ovh.api.nichandle.contactchange.OvhTask;
...
public class ApiOvhMe extends ApiOvhBase {
	 ...
	 * @param id [required]
	 */
	public OvhTask task_contactChange_id_GET(Long id) throws IOException {
	 ...
	 * @param id [required]
	 */
	public net.minidev.ovh.api.nichandle.emailchange.OvhTask task_emailChange_id_GET(Long id) throws IOException {
		String qPath = "/me/task/emailChange/{id}";
		StringBuilder sb = path(qPath, id);
		String resp = exec(qPath, "GET", sb.toString(), null);
		return convertTo(resp, net.minidev.ovh.api.nichandle.emailchange.OvhTask.class);
	}
	 ...
	 */
	public OvhPaymentMeanValidation paymentMean_creditCard_POST(String returnUrl, String description, Boolean setDefault) throws IOException {
		String qPath = "/me/paymentMean/creditCard";
		StringBuilder sb = path(qPath);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 */
	public OvhPaymentMeanValidation paymentMean_bankAccount_POST(String description, Boolean setDefault, String iban, String ownerName, String bic, String ownerAddress) throws IOException {
		String qPath = "/me/paymentMean/bankAccount";
		StringBuilder sb = path(qPath);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "description", description);
	 ...
	 */
	public net.minidev.ovh.api.nichandle.emailchange.OvhTask changeEmail_POST(String newEmail) throws IOException {
	...
	private static TypeReference<ArrayList<OvhFieldInformation>> t4 = new TypeReference<ArrayList<OvhFieldInformation>>() {};
	 ...
	 */
	public void ipOrganisation_POST(String lastname, OvhCountryEnum country, String address, String city, String state, String abuse_mailbox, String firstname, String zip, OvhIpRegistryEnum registry, String phone) throws IOException {
		String qPath = "/me/ipOrganisation";
		StringBuilder sb = path(qPath);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "lastname", lastname);
	 ...
	 */
	public void sshKey_POST(String keyName, String key) throws IOException {
		String qPath = "/me/sshKey";
		StringBuilder sb = path(qPath);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param schemeName [required] name of this partitioning scheme
	 */
	public void installationTemplate_templateName_partitionScheme_schemeName_partition_POST(String templateName, String schemeName, String volumeName, Long size, String mountpoint, OvhTemplateOsFileSystemEnum filesystem, Long step, Long raid, OvhTemplatePartitionTypeEnum type) throws IOException {
		String qPath = "/me/installationTemplate/{templateName}/partitionScheme/{schemeName}/partition";
		StringBuilder sb = path(qPath, templateName, schemeName);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param schemeName [required] name of this partitioning scheme
	 */
	public void installationTemplate_templateName_partitionScheme_schemeName_hardwareRaid_POST(String templateName, String schemeName, Long step, String[] disks, OvhTemplateOsHardwareRaidEnum mode, String name) throws IOException {
		String qPath = "/me/installationTemplate/{templateName}/partitionScheme/{schemeName}/hardwareRaid";
		StringBuilder sb = path(qPath, templateName, schemeName);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "step", step);
	...
	private static TypeReference<ArrayList<OvhRegisteredPaymentMean>> t7 = new TypeReference<ArrayList<OvhRegisteredPaymentMean>>() {};
