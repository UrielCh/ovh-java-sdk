...
public class ApiOvhRouter extends ApiOvhBase {
	 ...
	 * @param serviceName [required] The internal name of your Router offer
	 */
	public OvhVpn serviceName_vpn_POST(String serviceName, String clientIp, String clientPrivNet, String serverPrivNet, String psk) throws IOException {
		String qPath = "/router/{serviceName}/vpn";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param serviceName [required] The internal name of your Router offer
	 */
	public OvhTask serviceName_network_POST(String serviceName, String description, Long vlanTag, String ipNet) throws IOException {
		String qPath = "/router/{serviceName}/network";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
