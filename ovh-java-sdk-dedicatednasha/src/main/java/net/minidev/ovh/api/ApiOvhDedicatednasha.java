...
public class ApiOvhDedicatednasha extends ApiOvhBase {
	...
	private static TypeReference<ArrayList<OvhSnapshotEnum>> t3 = new TypeReference<ArrayList<OvhSnapshotEnum>>() {};
	 ...
	 * @param serviceName [required] The internal name of your storage
	 */
	public OvhTask serviceName_partition_POST(String serviceName, Long size, String partitionName, OvhProtocolEnum protocol) throws IOException {
		String qPath = "/dedicated/nasha/{serviceName}/partition";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "size", size);
