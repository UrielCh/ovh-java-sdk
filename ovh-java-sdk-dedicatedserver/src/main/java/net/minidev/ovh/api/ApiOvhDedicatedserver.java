...
import net.minidev.ovh.api.dedicated.OvhBinaryFirewall;
import net.minidev.ovh.api.dedicated.OvhBinaryFirewallLink;
import net.minidev.ovh.api.dedicated.OvhDatacenterAvailability;
...
public class ApiOvhDedicatedserver extends ApiOvhBase {
	...
	private static TypeReference<ArrayList<OvhOsAvailabilitiesEnum>> t2 = new TypeReference<ArrayList<OvhOsAvailabilitiesEnum>>() {};
	...
	private static TypeReference<ArrayList<OvhAccess>> t3 = new TypeReference<ArrayList<OvhAccess>>() {};
	...
	private static TypeReference<ArrayList<OvhWindowsSqlVersionEnum>> t6 = new TypeReference<ArrayList<OvhWindowsSqlVersionEnum>>() {};
	...
	private static TypeReference<ArrayList<OvhWindowsOsVersionEnum>> t7 = new TypeReference<ArrayList<OvhWindowsOsVersionEnum>>() {};
	...
	private static TypeReference<ArrayList<OvhRtmPci>> t8 = new TypeReference<ArrayList<OvhRtmPci>>() {};
	...
	private static TypeReference<ArrayList<OvhRtmMemory>> t9 = new TypeReference<ArrayList<OvhRtmMemory>>() {};
	...
	private static TypeReference<ArrayList<OvhRtmCommandSize>> t10 = new TypeReference<ArrayList<OvhRtmCommandSize>>() {};
	...
	private static TypeReference<ArrayList<OvhRtmConnection>> t11 = new TypeReference<ArrayList<OvhRtmConnection>>() {};
	...
	private static TypeReference<ArrayList<OvhOptionEnum>> t12 = new TypeReference<ArrayList<OvhOptionEnum>>() {};
	...
	private static TypeReference<ArrayList<OvhBootOptionEnum>> t13 = new TypeReference<ArrayList<OvhBootOptionEnum>>() {};
	...
	private static TypeReference<ArrayList<OvhIpCountryEnum>> t14 = new TypeReference<ArrayList<OvhIpCountryEnum>>() {};
	 ...
	 *
	 * REST: GET /dedicated/server/{serviceName}/firewall/binary/compatible
	 * @param serviceName [required] The internal name of your dedicated server
	 *
	 * API beta
	 */
	public OvhBinaryFirewall serviceName_firewall_binary_compatible_GET(String serviceName) throws IOException {
		String qPath = "/dedicated/server/{serviceName}/firewall/binary/compatible";
		StringBuilder sb = path(qPath, serviceName);
		String resp = exec(qPath, "GET", sb.toString(), null);
		return convertTo(resp, OvhBinaryFirewall.class);
	}

	/**
	 * Get url of binary to update firewall asa
	 *
	 * REST: GET /dedicated/server/{serviceName}/firewall/binary/link
	 * @param binaryName [required] Binary name
	 * @param serviceName [required] The internal name of your dedicated server
	 *
	 * API beta
	 */
	public OvhBinaryFirewallLink serviceName_firewall_binary_link_GET(String serviceName, String binaryName) throws IOException {
		String qPath = "/dedicated/server/{serviceName}/firewall/binary/link";
		StringBuilder sb = path(qPath, serviceName);
		query(sb, "binaryName", binaryName);
		String resp = exec(qPath, "GET", sb.toString(), null);
		return convertTo(resp, OvhBinaryFirewallLink.class);
	}
	 ...
	 * API beta
	 */
	public ArrayList<OvhDatacenterAvailability> datacenter_availabilities_GET(String datacenters, Boolean excludeDatacenters, String memory, String planCode, String server, String storage) throws IOException {
	...
	private static TypeReference<ArrayList<OvhDatacenterAvailability>> t15 = new TypeReference<ArrayList<OvhDatacenterAvailability>>() {};
	...
	private static TypeReference<ArrayList<OvhAvailabilities>> t17 = new TypeReference<ArrayList<OvhAvailabilities>>() {};
}
