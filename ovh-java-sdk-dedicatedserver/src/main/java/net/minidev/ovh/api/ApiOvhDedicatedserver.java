...
public class ApiOvhDedicatedserver extends ApiOvhBase {
	...
	private static TypeReference<ArrayList<OvhBootOptionEnum>> t5 = new TypeReference<ArrayList<OvhBootOptionEnum>>() {};
	 ...
	 * API beta
	 */
	public OvhNewMessageInfo serviceName_support_replace_hardDiskDrive_POST(String serviceName, Boolean inverse, OvhSupportReplaceHddInfo[] disks, String comment) throws IOException {
	 ...
	 * @param serviceName [required] The internal name of your dedicated server
	 */
	public OvhTask serviceName_install_start_POST(String serviceName, String templateName, OvhInstallCustom details, String partitionSchemeName) throws IOException {
	...
	private static TypeReference<ArrayList<OvhRtmConnection>> t6 = new TypeReference<ArrayList<OvhRtmConnection>>() {};
	...
	private static TypeReference<ArrayList<OvhRtmMemory>> t8 = new TypeReference<ArrayList<OvhRtmMemory>>() {};
	...
	private static TypeReference<ArrayList<OvhRtmCommandSize>> t9 = new TypeReference<ArrayList<OvhRtmCommandSize>>() {};
	...
	private static TypeReference<ArrayList<OvhAccess>> t11 = new TypeReference<ArrayList<OvhAccess>>() {};
	 ...
	 * @param serviceName [required] The internal name of your dedicated server
	 */
	public OvhTask serviceName_features_ipmi_access_POST(String serviceName, String sshKey, String ipToAllow, OvhCacheTTLEnum ttl, OvhIpmiAccessTypeEnum type) throws IOException {
		String qPath = "/dedicated/server/{serviceName}/features/ipmi/access";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
	...
	private static TypeReference<ArrayList<OvhOptionEnum>> t15 = new TypeReference<ArrayList<OvhOptionEnum>>() {};
	 ...
	 * @param monitoringId [required] This monitoring id
	 */
	public OvhSmsAlert serviceName_serviceMonitoring_monitoringId_alert_sms_POST(String serviceName, Long monitoringId, String phoneNumberTo, String smsAccount, Long fromHour, Long toHour, OvhAlertLanguageEnum language) throws IOException {
		String qPath = "/dedicated/server/{serviceName}/serviceMonitoring/{monitoringId}/alert/sms";
		StringBuilder sb = path(qPath, serviceName, monitoringId);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param serviceName [required] The internal name of your dedicated server
	 */
	public OvhServiceMonitoring serviceName_serviceMonitoring_POST(String serviceName, String url, String challengeText, Boolean enabled, String ip, OvhMonitoringIntervalEnum interval, Long port, OvhMonitoringProtocolEnum protocol) throws IOException {
		String qPath = "/dedicated/server/{serviceName}/serviceMonitoring";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "url", url);
