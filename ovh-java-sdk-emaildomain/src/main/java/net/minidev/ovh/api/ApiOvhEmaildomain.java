...
public class ApiOvhEmaildomain extends ApiOvhBase {
	 ...
	 * @param domain [required] Name of your domain name
	 */
	public OvhTaskSpecialAccount domain_responder_POST(String domain, Date to, String account, Date from, String content, String copyTo, Boolean copy) throws IOException {
		String qPath = "/email/domain/{domain}/responder";
		StringBuilder sb = path(qPath, domain);
	 ...
	 * @param domain [required] Name of your domain name
	 */
	public OvhTaskPop domain_account_POST(String domain, String description, Long size, String accountName, String password) throws IOException {
		String qPath = "/email/domain/{domain}/account";
		StringBuilder sb = path(qPath, domain);
		HashMap<String, Object>o = new HashMap<String, Object>();
	...
	private static TypeReference<ArrayList<OvhTaskFilter>> t3 = new TypeReference<ArrayList<OvhTaskFilter>>() {};
	 ...
	 * @param accountName [required] Name of account
	 */
	public OvhTaskFilter domain_account_accountName_filter_POST(String domain, String accountName, String name, String actionParam, Long priority, Boolean active, String header, String value, OvhDomainFilterActionEnum action, OvhDomainFilterOperandEnum operand) throws IOException {
		String qPath = "/email/domain/{domain}/account/{accountName}/filter";
		StringBuilder sb = path(qPath, domain, accountName);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "name", name);
	 ...
	 * @param domain [required] Name of your domain name
	 */
	public void domain_changeDnsMXFilter_POST(String domain, String customTarget, String subDomain, OvhDomainMXFilterEnum mxFilter) throws IOException {
	 ...
	 * @param domain [required] Name of your domain name
	 */
	public OvhTaskMl domain_mailingList_POST(String domain, String name, OvhDomainMlOptionsStruct options, OvhDomainMlLanguageEnum language, String ownerEmail, String replyTo) throws IOException {
		String qPath = "/email/domain/{domain}/mailingList";
		StringBuilder sb = path(qPath, domain);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "name", name);
	 ...
	 * @param email [required] Email
	 */
	public OvhTaskSpecialAccount delegatedAccount_email_responder_POST(String email, Date to, Date from, String content, String copyTo, Boolean copy) throws IOException {
		String qPath = "/email/domain/delegatedAccount/{email}/responder";
		StringBuilder sb = path(qPath, email);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "to", to);
	 ...
	 * @param email [required] Email
	 */
	public OvhTaskFilter delegatedAccount_email_filter_POST(String email, String name, String actionParam, Long priority, Boolean active, String header, String value, OvhDomainFilterActionEnum action, OvhDomainFilterOperandEnum operand) throws IOException {
		String qPath = "/email/domain/delegatedAccount/{email}/filter";
		StringBuilder sb = path(qPath, email);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "name", name);
