...
public class ApiOvhEmaildomain extends ApiOvhBase {
	 ...
	 */
	public String domain_confirmTermination_POST(String domain, String commentary, String token, OvhTerminationReasonEnum reason) throws IOException {
	 ...
	 * @param domain [required] Name of your domain name
	 */
	public OvhTaskMl domain_mailingList_POST(String domain, OvhDomainMlOptionsStruct options, String ownerEmail, String name, OvhDomainMlLanguageEnum language, String replyTo) throws IOException {
		String qPath = "/email/domain/{domain}/mailingList";
		StringBuilder sb = path(qPath, domain);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param domain [required] Name of your domain name
	 */
	public OvhTaskSpecialAccount domain_responder_POST(String domain, Date to, String account, Boolean copy, String content, Date from, String copyTo) throws IOException {
		String qPath = "/email/domain/{domain}/responder";
		StringBuilder sb = path(qPath, domain);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "to", to);
	 ...
	 * @param accountName [required] Name of account
	 */
	public OvhTaskFilter domain_account_accountName_filter_POST(String domain, String accountName, String name, OvhDomainFilterActionEnum action, String actionParam, String value, Long priority, String header, OvhDomainFilterOperandEnum operand, Boolean active) throws IOException {
		String qPath = "/email/domain/{domain}/account/{accountName}/filter";
		StringBuilder sb = path(qPath, domain, accountName);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "name", name);
	 ...
	 * @param name [required] Filter name
	 */
	public OvhTaskFilter domain_account_accountName_filter_name_rule_POST(String domain, String accountName, String name, String value, String header, OvhDomainFilterOperandEnum operand) throws IOException {
		String qPath = "/email/domain/{domain}/account/{accountName}/filter/{name}/rule";
		StringBuilder sb = path(qPath, domain, accountName, name);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "value", value);
	 ...
	 * @param domain [required] Name of your domain name
	 */
	public OvhTaskSpecialAccount domain_redirection_POST(String domain, Boolean localCopy, String to, String from) throws IOException {
		String qPath = "/email/domain/{domain}/redirection";
		StringBuilder sb = path(qPath, domain);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param email [required] Email
	 */
	public OvhTaskSpecialAccount delegatedAccount_email_responder_POST(String email, String copyTo, String content, Date from, Date to, Boolean copy) throws IOException {
		String qPath = "/email/domain/delegatedAccount/{email}/responder";
		StringBuilder sb = path(qPath, email);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "copyTo", copyTo);
	 ...
	 * @param name [required] Filter name
	 */
	public OvhTaskFilter delegatedAccount_email_filter_name_rule_POST(String email, String name, String value, String header, OvhDomainFilterOperandEnum operand) throws IOException {
		String qPath = "/email/domain/delegatedAccount/{email}/filter/{name}/rule";
		StringBuilder sb = path(qPath, email, name);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "value", value);
	 ...
	 * @param email [required] Email
	 */
	public OvhTaskFilter delegatedAccount_email_filter_POST(String email, String name, OvhDomainFilterActionEnum action, String actionParam, String value, Long priority, String header, OvhDomainFilterOperandEnum operand, Boolean active) throws IOException {
		String qPath = "/email/domain/delegatedAccount/{email}/filter";
		StringBuilder sb = path(qPath, email);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "name", name);
