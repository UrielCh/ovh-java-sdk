...
public class ApiOvhConnectivity extends ApiOvhBase {
	...
	private static TypeReference<OvhAsyncTaskArray<OvhBuilding>> t1 = new TypeReference<OvhAsyncTaskArray<OvhBuilding>>() {};
	...
	private static TypeReference<OvhAsyncTaskArray<OvhLine>> t2 = new TypeReference<OvhAsyncTaskArray<OvhLine>>() {};
	...
	private static TypeReference<OvhAsyncTaskArray<OvhStreet>> t3 = new TypeReference<OvhAsyncTaskArray<OvhStreet>>() {};
	...
	private static TypeReference<OvhAsyncTask<OvhMeetings>> t6 = new TypeReference<OvhAsyncTask<OvhMeetings>>() {};
	...
	private static TypeReference<OvhAsyncTask<OvhEligibilityTest>> t8 = new TypeReference<OvhAsyncTask<OvhEligibilityTest>>() {};
