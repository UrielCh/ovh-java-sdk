...
public class ApiOvhConnectivity extends ApiOvhBase {
	...
	private static TypeReference<OvhAsyncTaskArray<OvhLine>> t4 = new TypeReference<OvhAsyncTaskArray<OvhLine>>() {};
	...
	private static TypeReference<OvhAsyncTask<OvhBuilding>> t7 = new TypeReference<OvhAsyncTask<OvhBuilding>>() {};
