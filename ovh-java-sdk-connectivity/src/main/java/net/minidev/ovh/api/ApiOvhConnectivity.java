...
public class ApiOvhConnectivity extends ApiOvhBase {
	 ...
	 */
	public OvhAsyncTask<OvhEligibilityTest> eligibility_test_line_POST(OvhLineStatusEnum status, String lineNumber) throws IOException {
	...
	private static TypeReference<OvhAsyncTask<OvhBuilding>> t2 = new TypeReference<OvhAsyncTask<OvhBuilding>>() {};
	...
	private static TypeReference<OvhAsyncTask<OvhMeetings>> t3 = new TypeReference<OvhAsyncTask<OvhMeetings>>() {};
	...
	private static TypeReference<OvhAsyncTaskArray<OvhCity>> t4 = new TypeReference<OvhAsyncTaskArray<OvhCity>>() {};
	 ...
	 */
	public OvhAsyncTaskArray<OvhLine> eligibility_search_lines_POST(String streetCode, String ownerName, String streetNumber) throws IOException {
	...
	private static TypeReference<OvhAsyncTaskArray<String>> t6 = new TypeReference<OvhAsyncTaskArray<String>>() {};
	...
	private static TypeReference<OvhAsyncTaskArray<OvhBuilding>> t7 = new TypeReference<OvhAsyncTaskArray<OvhBuilding>>() {};
	...
	private static TypeReference<OvhAsyncTaskArray<OvhStreet>> t8 = new TypeReference<OvhAsyncTaskArray<OvhStreet>>() {};
}
