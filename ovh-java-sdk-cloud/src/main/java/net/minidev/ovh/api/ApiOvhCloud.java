...
public class ApiOvhCloud extends ApiOvhBase {
	 ...
	 * @deprecated
	 */
	public OvhTask serviceName_pca_pcaServiceName_tasks_POST(String serviceName, String pcaServiceName, String sessionId, String[] fileIds, OvhTaskTypeEnum taskFunction) throws IOException {
		String qPath = "/cloud/{serviceName}/pca/{pcaServiceName}/tasks";
		StringBuilder sb = path(qPath, serviceName, pcaServiceName);
	 ...
	 * @param voucher [required] Voucher code
	 */
	public OvhNewProject createProject_POST(String description, Long credit, String voucher) throws IOException {
	...
	private static TypeReference<ArrayList<OvhBackup>> t4 = new TypeReference<ArrayList<OvhBackup>>() {};
	...
	private static TypeReference<ArrayList<OvhImage>> t5 = new TypeReference<ArrayList<OvhImage>>() {};
	...
	private static TypeReference<ArrayList<OvhUsageHistory>> t7 = new TypeReference<ArrayList<OvhUsageHistory>>() {};
	...
	private static TypeReference<ArrayList<OvhSshKey>> t9 = new TypeReference<ArrayList<OvhSshKey>>() {};
	...
	private static TypeReference<ArrayList<OvhBill>> t10 = new TypeReference<ArrayList<OvhBill>>() {};
	...
	private static TypeReference<ArrayList<OvhStack>> t11 = new TypeReference<ArrayList<OvhStack>>() {};
	...
	private static TypeReference<ArrayList<OvhCloudIp>> t13 = new TypeReference<ArrayList<OvhCloudIp>>() {};
	...
	private static TypeReference<ArrayList<OvhContainer>> t14 = new TypeReference<ArrayList<OvhContainer>>() {};
	...
	private static TypeReference<ArrayList<OvhNetwork>> t16 = new TypeReference<ArrayList<OvhNetwork>>() {};
	...
	private static TypeReference<ArrayList<OvhSubnet>> t17 = new TypeReference<ArrayList<OvhSubnet>>() {};
	 ...
	 * @param serviceName [required] The project id
	 */
	public OvhAlerting project_serviceName_alerting_POST(String serviceName, String email, OvhAlertingDelayEnum delay, Long monthlyThreshold) throws IOException {
		String qPath = "/cloud/project/{serviceName}/alerting";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
	...
	private static TypeReference<ArrayList<OvhVolume>> t19 = new TypeReference<ArrayList<OvhVolume>>() {};
	...
	private static TypeReference<ArrayList<OvhInterface>> t20 = new TypeReference<ArrayList<OvhInterface>>() {};
	...
	private static TypeReference<ArrayList<OvhInstance>> t22 = new TypeReference<ArrayList<OvhInstance>>() {};
	 ...
	 * @param serviceName [required] The project id
	 */
	public OvhAcl project_serviceName_acl_POST(String serviceName, OvhAclTypeEnum type, String accountId) throws IOException {
		String qPath = "/cloud/project/{serviceName}/acl";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "type", type);
