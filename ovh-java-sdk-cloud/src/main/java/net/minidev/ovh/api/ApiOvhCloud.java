...
import net.minidev.ovh.api.cloud.backup.OvhWorkflowBackup;
...
public class ApiOvhCloud extends ApiOvhBase {
	 ...
	 * @deprecated
	 */
	public OvhTask serviceName_pca_pcaServiceName_tasks_POST(String serviceName, String pcaServiceName, OvhTaskTypeEnum taskFunction, String sessionId, String[] fileIds) throws IOException {
		String qPath = "/cloud/{serviceName}/pca/{pcaServiceName}/tasks";
		StringBuilder sb = path(qPath, serviceName, pcaServiceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
	...
	private static TypeReference<ArrayList<OvhOrder>> t3 = new TypeReference<ArrayList<OvhOrder>>() {};
	...
	private static TypeReference<ArrayList<OvhFailoverIp>> t4 = new TypeReference<ArrayList<OvhFailoverIp>>() {};
	...
	private static TypeReference<ArrayList<OvhCloudIp>> t5 = new TypeReference<ArrayList<OvhCloudIp>>() {};
	...
	private static TypeReference<ArrayList<OvhContainer>> t7 = new TypeReference<ArrayList<OvhContainer>>() {};
	...
	private static TypeReference<ArrayList<OvhSubnet>> t9 = new TypeReference<ArrayList<OvhSubnet>>() {};
	...
	private static TypeReference<ArrayList<OvhNetwork>> t10 = new TypeReference<ArrayList<OvhNetwork>>() {};
	...
	private static TypeReference<ArrayList<OvhImage>> t11 = new TypeReference<ArrayList<OvhImage>>() {};
	...
	private static TypeReference<ArrayList<OvhQuotas>> t12 = new TypeReference<ArrayList<OvhQuotas>>() {};
	...
	private static TypeReference<ArrayList<OvhInterface>> t13 = new TypeReference<ArrayList<OvhInterface>>() {};
	...
	private static TypeReference<ArrayList<OvhUsageHistory>> t16 = new TypeReference<ArrayList<OvhUsageHistory>>() {};
	...
	private static TypeReference<ArrayList<OvhVolume>> t18 = new TypeReference<ArrayList<OvhVolume>>() {};
	...
	/**
	 * Remove an autobackup
	 *
	 * REST: DELETE /cloud/project/{serviceName}/region/{regionName}/workflow/backup/{backupId}
	 * @param backupId [required] Backup ID
	 * @param regionName [required] Region name
	 * @param serviceName [required] Service name
	 *
	 * API beta
	 */
	public void project_serviceName_region_regionName_workflow_backup_backupId_DELETE(String serviceName, String regionName, String backupId) throws IOException {
		String qPath = "/cloud/project/{serviceName}/region/{regionName}/workflow/backup/{backupId}";
		StringBuilder sb = path(qPath, serviceName, regionName, backupId);
		exec(qPath, "DELETE", sb.toString(), null);
	}

	/**
	 * List created autobackup
	 *
	 ...
	 * API beta
	 */
	public ArrayList<OvhWorkflowBackup> project_serviceName_region_regionName_workflow_backup_GET(String serviceName, String regionName, String instanceId) throws IOException {
	...
	private static TypeReference<ArrayList<OvhWorkflowBackup>> t19 = new TypeReference<ArrayList<OvhWorkflowBackup>>() {};

	/**
	 * Add an autobackup for an instance
	 *
	 * REST: POST /cloud/project/{serviceName}/region/{regionName}/workflow/backup
	 * @param cron [required] Cron pattern (eg: '* * * * *')
	 * @param instanceId [required] Instance id
	 * @param maxExecutionCount [required] Number of execution to do. Let it empty if must never end.
	 ...
	 * API beta
	 */
	public OvhWorkflowBackup project_serviceName_region_regionName_workflow_backup_POST(String serviceName, String regionName, String cron, String instanceId, Long maxExecutionCount, String name, Long rotation) throws IOException {
		String qPath = "/cloud/project/{serviceName}/region/{regionName}/workflow/backup";
		StringBuilder sb = path(qPath, serviceName, regionName);
		HashMap<String, Object>o = new HashMap<String, Object>();
		addBody(o, "cron", cron);
		...
		String resp = exec(qPath, "POST", sb.toString(), o);
		return convertTo(resp, OvhWorkflowBackup.class);
	}
	...
	private static TypeReference<ArrayList<OvhStack>> t21 = new TypeReference<ArrayList<OvhStack>>() {};
	...
	private static TypeReference<ArrayList<OvhSshKey>> t22 = new TypeReference<ArrayList<OvhSshKey>>() {};
	...
	private static TypeReference<ArrayList<OvhMigration>> t23 = new TypeReference<ArrayList<OvhMigration>>() {};
}
