...
import net.minidev.ovh.api.cloud.OvhAvailableRegion;
...
import net.minidev.ovh.api.cloud.OvhOperation;
...
import net.minidev.ovh.api.cloud.openstackclient.OvhSession;
...
public class ApiOvhCloud extends ApiOvhBase {
	...
	private static TypeReference<ArrayList<OvhBackup>> t2 = new TypeReference<ArrayList<OvhBackup>>() {};
	 ...
	 *
	 * REST: POST /cloud/project/{serviceName}/vrack
	 * @param serviceName [required] Public Cloud project
	 *
	 * API beta
	 */
	public OvhOperation project_serviceName_vrack_POST(String serviceName) throws IOException {
		String qPath = "/cloud/project/{serviceName}/vrack";
		StringBuilder sb = path(qPath, serviceName);
	...
	private static TypeReference<ArrayList<OvhUser>> t4 = new TypeReference<ArrayList<OvhUser>>() {};
	...
	private static TypeReference<ArrayList<OvhContainer>> t5 = new TypeReference<ArrayList<OvhContainer>>() {};
	...
	private static TypeReference<ArrayList<OvhSubnet>> t6 = new TypeReference<ArrayList<OvhSubnet>>() {};
	...
	private static TypeReference<ArrayList<OvhNetwork>> t7 = new TypeReference<ArrayList<OvhNetwork>>() {};
	 ...
	 *
	 * REST: GET /cloud/project/{serviceName}/operation/{operationId}
	 * @param operationId [required] Operation ID
	 * @param serviceName [required] Public Cloud project
	 *
	 * API beta
	 */
	public OvhOperation project_serviceName_operation_operationId_GET(String serviceName, String operationId) throws IOException {
		String qPath = "/cloud/project/{serviceName}/operation/{operationId}";
	...
	private static TypeReference<ArrayList<OvhOperation>> t8 = new TypeReference<ArrayList<OvhOperation>>() {};
	...
	private static TypeReference<ArrayList<OvhMigration>> t10 = new TypeReference<ArrayList<OvhMigration>>() {};
	...
	private static TypeReference<ArrayList<OvhVolume>> t11 = new TypeReference<ArrayList<OvhVolume>>() {};
	...
	private static TypeReference<ArrayList<OvhSnapshot>> t12 = new TypeReference<ArrayList<OvhSnapshot>>() {};
	...
	private static TypeReference<ArrayList<OvhFailoverIp>> t13 = new TypeReference<ArrayList<OvhFailoverIp>>() {};
	...
	private static TypeReference<ArrayList<OvhCloudIp>> t14 = new TypeReference<ArrayList<OvhCloudIp>>() {};
	 ...
	 * API beta
	 */
	public OvhSession project_serviceName_stack_stackId_client_POST(String serviceName, String stackId) throws IOException {
	...
	private static TypeReference<ArrayList<OvhStack>> t15 = new TypeReference<ArrayList<OvhStack>>() {};
	...
	private static TypeReference<ArrayList<OvhQuotas>> t16 = new TypeReference<ArrayList<OvhQuotas>>() {};
	 ...
	 * API beta
	 */
	public OvhSession project_serviceName_openstackClient_POST(String serviceName) throws IOException {
	...
	private static TypeReference<ArrayList<OvhAvailableRegion>> t18 = new TypeReference<ArrayList<OvhAvailableRegion>>() {};
	...
	private static TypeReference<ArrayList<OvhInstance>> t21 = new TypeReference<ArrayList<OvhInstance>>() {};
	...
	private static TypeReference<ArrayList<OvhInterface>> t22 = new TypeReference<ArrayList<OvhInterface>>() {};
	...
	private static TypeReference<ArrayList<OvhInstanceGroup>> t23 = new TypeReference<ArrayList<OvhInstanceGroup>>() {};
	...
	public ArrayList<OvhFlavor> project_serviceName_flavor_GET(String serviceName, String region) throws IOException {
		...
		query(sb, "region", region);
		String resp = exec(qPath, "GET", sb.toString(), null);
		return convertTo(resp, t24);
	}
	private static TypeReference<ArrayList<OvhFlavor>> t24 = new TypeReference<ArrayList<OvhFlavor>>() {};
	...
	private static TypeReference<ArrayList<OvhOrder>> t25 = new TypeReference<ArrayList<OvhOrder>>() {};
	 ...
	 * @deprecated
	 */
	public net.minidev.ovh.api.pca.OvhSession serviceName_pca_pcaServiceName_sessions_sessionId_GET(String serviceName, String pcaServiceName, String sessionId) throws IOException {
		String qPath = "/cloud/{serviceName}/pca/{pcaServiceName}/sessions/{sessionId}";
		StringBuilder sb = path(qPath, serviceName, pcaServiceName, sessionId);
		String resp = exec(qPath, "GET", sb.toString(), null);
		return convertTo(resp, net.minidev.ovh.api.pca.OvhSession.class);
	}
	 ...
	 * @deprecated
	 */
	public void serviceName_pca_pcaServiceName_sessions_sessionId_PUT(String serviceName, String pcaServiceName, String sessionId, net.minidev.ovh.api.pca.OvhSession body) throws IOException {
		String qPath = "/cloud/{serviceName}/pca/{pcaServiceName}/sessions/{sessionId}";
		StringBuilder sb = path(qPath, serviceName, pcaServiceName, sessionId);
		exec(qPath, "PUT", sb.toString(), body);
	}
