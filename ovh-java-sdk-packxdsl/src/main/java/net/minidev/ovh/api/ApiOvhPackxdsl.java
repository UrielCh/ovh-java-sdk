...
public class ApiOvhPackxdsl extends ApiOvhBase {
	...
	private static TypeReference<OvhAsyncTask<OvhMigrationOfferResponse>> t3 = new TypeReference<OvhAsyncTask<OvhMigrationOfferResponse>>() {};
	...
	private static TypeReference<ArrayList<OvhSubServiceToDelete>> t4 = new TypeReference<ArrayList<OvhSubServiceToDelete>>() {};
	...
	private static TypeReference<OvhAsyncTask<OvhEligibility>> t5 = new TypeReference<OvhAsyncTask<OvhEligibility>>() {};
	...
	private static TypeReference<OvhAsyncTask<Long>> t6 = new TypeReference<OvhAsyncTask<Long>>() {};
	...
	private static TypeReference<ArrayList<OvhServiceInformation>> t7 = new TypeReference<ArrayList<OvhServiceInformation>>() {};
	...
	private static TypeReference<ArrayList<OvhSiteBuilderDomain>> t8 = new TypeReference<ArrayList<OvhSiteBuilderDomain>>() {};
	...
	private static TypeReference<ArrayList<OvhSiteBuilderTemplate>> t9 = new TypeReference<ArrayList<OvhSiteBuilderTemplate>>() {};
