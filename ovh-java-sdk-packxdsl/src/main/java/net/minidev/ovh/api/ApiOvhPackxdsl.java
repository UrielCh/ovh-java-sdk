...
public class ApiOvhPackxdsl extends ApiOvhBase {
	...
	private static TypeReference<ArrayList<OvhVoIPHardware>> t3 = new TypeReference<ArrayList<OvhVoIPHardware>>() {};
	...
	private static TypeReference<ArrayList<OvhSiteBuilderDomain>> t5 = new TypeReference<ArrayList<OvhSiteBuilderDomain>>() {};
	 ...
	 * @param firstName [required] First name
	 * @param antispam [required] Antispam protection
	 * @param packName [required] The internal name of your pack
	 * @deprecated
	 */
	...
	private static TypeReference<ArrayList<OvhSubServiceToDelete>> t9 = new TypeReference<ArrayList<OvhSubServiceToDelete>>() {};
	...
	private static TypeReference<OvhAsyncTask<OvhEligibility>> t11 = new TypeReference<OvhAsyncTask<OvhEligibility>>() {};
