...
public class ApiOvhXdsl extends ApiOvhBase {
	...
	private static TypeReference<OvhAsyncTask<OvhFiberEligibility>> t2 = new TypeReference<OvhAsyncTask<OvhFiberEligibility>>() {};
	...
	private static TypeReference<ArrayList<OvhStreet>> t5 = new TypeReference<ArrayList<OvhStreet>>() {};
	 ...
	 * @deprecated
	 */
	public OvhAsyncTaskArray<OvhLine> eligibility_lines_active_POST(String streetNumber, String contactName, OvhStreet street, OvhCity city) throws IOException {
	 ...
	 * @deprecated
	 */
	public OvhAsyncTaskArray<OvhLine> eligibility_lines_inactive_POST(String streetNumber, OvhStreet street, String contactName, OvhCity city) throws IOException {
	...
	private static TypeReference<OvhAsyncTaskArray<OvhCity>> t7 = new TypeReference<OvhAsyncTaskArray<OvhCity>>() {};
	 ...
	 * @deprecated
	 */
	public OvhAsyncTaskArray<OvhBuilding> eligibility_search_buildings_POST(String streetNumber, String streetCode) throws IOException {
	...
	private static TypeReference<OvhAsyncTaskArray<OvhBuilding>> t8 = new TypeReference<OvhAsyncTaskArray<OvhBuilding>>() {};
	...
	private static TypeReference<OvhAsyncTaskArray<String>> t9 = new TypeReference<OvhAsyncTaskArray<String>>() {};
	...
	private static TypeReference<OvhAsyncTaskArray<OvhFiberStreet>> t10 = new TypeReference<OvhAsyncTaskArray<OvhFiberStreet>>() {};
	 ...
	 * API beta
	 */
	public OvhTemplateModem templateModem_POST(String serviceName, String name) throws IOException {
		String qPath = "/xdsl/templateModem";
		StringBuilder sb = path(qPath);
		HashMap<String, Object>o = new HashMap<String, Object>();
	...
	private static TypeReference<ArrayList<OvhDslamLineProfile>> t13 = new TypeReference<ArrayList<OvhDslamLineProfile>>() {};
	...
	private static TypeReference<ArrayList<OvhDslamPortLog>> t14 = new TypeReference<ArrayList<OvhDslamPortLog>>() {};
	 ...
	 * @param serviceName [required] The internal name of your XDSL offer
	 */
	public OvhMonitoringNotification serviceName_monitoringNotifications_POST(String serviceName, Long downThreshold, String email, OvhTypeEnum type, Boolean allowIncident, String smsAccount, OvhFrequencyEnum frequency, String phone) throws IOException {
		String qPath = "/xdsl/{serviceName}/monitoringNotifications";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
	...
	private static TypeReference<ArrayList<OvhRadiusConnectionLog>> t16 = new TypeReference<ArrayList<OvhRadiusConnectionLog>>() {};
	 ...
	 * @param serviceName [required] The internal name of your XDSL offer
	 */
	public OvhPortMapping serviceName_modem_portMappings_POST(String serviceName, OvhProtocolTypeEnum protocol, String description, String name, Long externalPortEnd, Long internalPort, String allowedRemoteIp, String internalClient, Long externalPortStart) throws IOException {
		String qPath = "/xdsl/{serviceName}/modem/portMappings";
		StringBuilder sb = path(qPath, serviceName);
		HashMap<String, Object>o = new HashMap<String, Object>();
	 ...
	 * @param dhcpName [required] Name of the DHCP
	 */
	public OvhDHCPStaticAddress serviceName_modem_lan_lanName_dhcp_dhcpName_DHCPStaticAddresses_POST(String serviceName, String lanName, String dhcpName, String MACAddress, String name, String IPAddress) throws IOException {
		String qPath = "/xdsl/{serviceName}/modem/lan/{lanName}/dhcp/{dhcpName}/DHCPStaticAddresses";
		StringBuilder sb = path(qPath, serviceName, lanName, dhcpName);
		HashMap<String, Object>o = new HashMap<String, Object>();
	...
	private static TypeReference<OvhAsyncTask<OvhModemInfo>> t18 = new TypeReference<OvhAsyncTask<OvhModemInfo>>() {};
